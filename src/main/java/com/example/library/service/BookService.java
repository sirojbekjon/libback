...
import com.example.library.payload.repository.BookRepository;
import com.example.library.payload.repository.BooksTypeRepository;
...
public class BookService {
    ...
    public ApiResponse addBook(BookDto bookDto) {
        try {
            Optional<BooksType> optionalBooksType = booksTypeRepository.findById(bookDto.getBooksType());
